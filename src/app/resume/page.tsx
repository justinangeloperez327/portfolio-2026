...
const currentWork = [
  {
    name: "Berserk",
    detail: "Rust web framework · Active",
    href: "/work/berserk",
  },
  {
    name: "Gungnir",
    detail: "C++ web framework · Active",
    href: "/work/gungnir",
  },
  {
    name: "Densleaf",
    detail: "Rust-based programming language · Experimental",
    href: "/work/densleaf",
  },
  {
    name: "Quagmire",
    detail: "Frontend framework · Experimental",
    href: "/work/quagmire",
  },
] as const;
